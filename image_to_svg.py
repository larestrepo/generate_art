...
def rgba_image_to_svg_pixels(im, opaque=None):
    #s = io.StringIO()
    s = open('MoxieGalleryFondos_0009_Capa-1'+".svg","w")
...
if __name__ == "__main__":
    ...
    # print png_to_svg('image.png', contiguous=options.contiguous, opaque=options.opaque, keep_every_point=options.keep_every_point)

    png_to_svg('./image_to_svg/MoxieGalleryFondos_0009_Capa-1.png')