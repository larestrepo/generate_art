...
if __name__ == '__main__':
    # picCircles("./svg_play/gerberas.jpeg",'flower')
    # picCircles("./svg_play/rose2.jpg",'rose')
    # picCircles("./svg_play/zebra.jpg",'zebra')
    picCircles("./cuadros-NFT_Color1.jpg",'Tubérculos')
